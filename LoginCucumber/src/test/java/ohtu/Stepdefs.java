...
public class Stepdefs {
    ...
    public void user_with_password_is_created(String username, String password) throws Throwable {
        ...
        new_username_and_password_are_entered(username, password);
    }
    ...
    @When("^username \"([^\"]*)\" with password \"([^\"]*)\" is selected$")
    public void username_with_password_is_selected(String username, String password) throws Throwable {
        inputLines.add(username);
        inputLines.add(password);
